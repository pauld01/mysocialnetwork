        ...
        <article>
            <div class="user-publier">
                <div class="user-name">
                    <?php
                        if(!isset($_SESSION['pseudo'])){
                            echo "<h3> Connectez-vous afin de profiter de toutes les fonctionnalités de notre site ! </h3>";
                        }else{
                ...
                <form method="post" enctype="multipart/form-data" action="outils/add-publication.php" id="publication">
                    <fieldset>
                        <textarea name="text-publication" rows="5" cols="33" placeholder="Dites à tout le monde ce que vous faite" required></textarea>
                        <div class="container">
                            <label for="file" class="label-file"><img class="img-File" src="images/iconePhoto_pub.png" alt="Ajouter une image à votre publication !"/>
                        ...
                        <div class="container">
                            <label for="fileVid" class="label-file"><img class="img-File" src="images/iconeVideo_pub.png" alt="Ajouter une image à votre publication !"/>
                            <input type="file" id="fileVid" name="video" accept="video/mp4"/>
                            <div class="img-txt">
                                <span class="img-file-txt">Ajouter une vidéo</span>
                            </div>
                            </label>
                        </div>
                    </fieldset>
